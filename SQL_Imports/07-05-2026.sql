...
-- Tiempo de generación: 07-05-2026 a las 00:01:55
...
INSERT INTO `carrito` (`id`, `usuario_id`, `juego_id`, `cantidad`, `fecha_agregado`) VALUES
(7, 2, 7, 1, '2026-05-02 16:51:05'),
(8, 2, 2, 1, '2026-05-02 16:51:06'),
(16, 1, 3, 1, '2026-05-05 14:33:52'),
(17, 17, 5, 1, '2026-05-05 14:37:44');
...
(6, 2, 2, '2026-05-02 16:50:15'),
(7, 2, 7, '2026-05-02 16:50:17'),
(8, 2, 10, '2026-05-02 16:50:19'),
(12, 1, 3, '2026-05-04 20:04:23'),
(14, 1, 11, '2026-05-04 20:04:34'),
(15, 1, 5, '2026-05-04 20:16:46'),
(16, 17, 5, '2026-05-05 14:37:42');
...
INSERT INTO `juegos` (`id`, `titulo`, `plataforma_id`, `fecha_lanzamiento`, `imagen`, `es_nueva_consola`, `precio`, `descuento`) VALUES
(1, 'RESIDENT EVIL Requiem', 1, '2026-02-27', './fotos/juegos/resident-evil-requiem.jpg', 1, 69.99, 50),
(2, 'DRAGON QUEST VII Reimagined', 1, '2026-02-03', './fotos/juegos/dragon-quest.jpg', 1, 59.60, 0),
(3, 'Monster Hunter Stories 3: Twisted Reflection', 1, '2026-03-13', './fotos/juegos/monster-hunte.jpg', 1, 50.60, 0),
(4, 'Mario Kart World', 1, '2025-06-25', './fotos/juegos/mario-kart-world.jpg', 1, 49.90, 0),
(5, 'Celeste', 2, '2023-07-23', './fotos/juegos/celeste.jpg', 0, 9.99, 0),
(6, 'FALLOUT 4', 1, '2017-06-21', './fotos/juegos/fallout-4.jpg', 1, 79.99, 0),
(7, 'Persona 5 Royal', 2, '2026-03-03', './fotos/juegos/persona-5-royal.jpg', 0, 59.99, 0),
(8, 'Hades II', 1, '2019-06-28', './fotos/juegos/hades_2.jpg', 1, 29.99, 0),
(9, 'Miitopia', 2, '2026-04-01', './fotos/juegos/miitopia.jpg', 0, 89.99, 0),
(10, 'Animal Croosing New Horizons', 2, '2020-05-05', './fotos/juegos/nh.jpg', 0, 59.99, 0),
(11, 'Pokemon FireRed Version', 1, '2009-01-14', './fotos/juegos/pokemon-firered.jpg', 1, 9.99, 0),
(12, 'Pokemon Escarlata', 2, '2024-11-07', './fotos/juegos/pokemon-scarlet.jpg', 0, 8.99, 0),
(13, 'Zelda Breath Of The Wild', 2, '2017-06-16', './fotos/juegos/Zelda_botw.jpg', 0, 49.99, 0),
(14, 'Elden Ring', 1, '2026-05-05', './fotos/juegos/elden-ring.jpg', 1, 30.99, 0);
...
(1, 'Admin Principal', 'admin@nintendo.com', 'Admin123', 'admin', 'activo', '2023-01-15', 'https://i.pinimg.com/1200x/88/74/b4/8874b4647924d667c8cf3f8277a1bb82.jpg', 0),
(2, 'Jairo', 'jairo@nintendo.com', 'Jairo123', 'admin', 'activo', '2023-05-19', 'https://i.pinimg.com/736x/e5/b5/84/e5b5845fd3c0ae43eb58403f792e46e5.jpg', 0),
...
(5, 'Zelda', 'princess.zelda@hyrule.gov', 'Zelda123', 'user', 'activo', '2023-08-11', 'https://ui-avatars.com/api/?name=Z&background=ca8a04&color=fff', 0),
...
(17, 'Invitado', 'invitado@nintendo.com', 'Invitado123', 'game_manager', 'bloqueado', '2026-05-05', 'https://ui-avatars.com/api/?name=I&background=E60012&color=fff', 0);
